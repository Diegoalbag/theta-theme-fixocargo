...
//   * A `servicios-cta` section inserted BEFORE this change stores the
//     then-current default in its own saved data and KEEPS RENDERING IT. No
//     shipped merchant page changes appearance because of this edit, which is
//     what the backward-compatibility rule requires.
...
// The destructured `banner2Kicker = ""` default is kept and emptied (never
// deleted) so `undefined` can never reach PromoBanner's own unrelated default.
//
