...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/diegoalba/Documents/theta-theme-starter/.claude/.gsd-surface.json`
(sibling to `/Users/diegoalba/Documents/theta-theme-starter/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/diegoalba/Documents/theta-theme-starter/.claude/skills/gsd-*/`.
...
(`/Users/diegoalba/Documents/theta-theme-starter/.claude`), NOT the skills sub-directory (`/Users/diegoalba/Documents/theta-theme-starter/.claude/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/Users/diegoalba/Documents/theta-theme-starter/.claude` as `configDir`. The skill dirs themselves live at
`/Users/diegoalba/Documents/theta-theme-starter/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Claude Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/Users/diegoalba/Documents/theta-theme-starter/.claude}"
SCOPE="global"
...
(i.e. `/Users/diegoalba/Documents/theta-theme-starter/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/diegoalba/Documents/theta-theme-starter/.claude/.gsd-surface.json`
Install profile marker: `/Users/diegoalba/Documents/theta-theme-starter/.claude/.gsd-profile`
Skill dirs: `/Users/diegoalba/Documents/theta-theme-starter/.claude/skills/gsd-*/`
Engine module: `/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
