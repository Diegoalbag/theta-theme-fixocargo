...
- **Global scope**: `/Users/diegoalba/Documents/theta-theme-starter/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/diegoalba/Documents/theta-theme-starter/.claude/notes/`)
...
2. Glob `/Users/diegoalba/Documents/theta-theme-starter/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/diegoalba/Documents/theta-theme-starter/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/diegoalba/Documents/theta-theme-starter/.claude/notes/` — works in any directory
