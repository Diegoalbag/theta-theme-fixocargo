...
```
Agent(
  prompt="Read /Users/diegoalba/Documents/theta-theme-starter/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/templates/SECURITY.md`
