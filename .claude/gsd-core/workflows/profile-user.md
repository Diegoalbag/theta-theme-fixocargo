...
Key references:
- @/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/Users/diegoalba/Documents/theta-theme-starter/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/USER-PROFILE.md" "/Users/diegoalba/Documents/theta-theme-starter/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/diegoalba/Documents/theta-theme-starter/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/diegoalba/Documents/theta-theme-starter/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/diegoalba/Documents/theta-theme-starter/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/diegoalba/Documents/theta-theme-starter/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/diegoalba/Documents/theta-theme-starter/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        /Users/diegoalba/Documents/theta-theme-starter/.claude/CLAUDE.md
```
