...
ones). Reference: @/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/diegoalba/Documents/theta-theme-starter/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/diegoalba/Documents/theta-theme-starter/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/templates/spec.md.
