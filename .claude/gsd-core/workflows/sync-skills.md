...
INSTALL_JS_GLOBAL="/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
