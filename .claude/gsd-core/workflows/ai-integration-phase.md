...
<required_reading>
@/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/references/ai-frameworks.md
@/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/diegoalba/Documents/theta-theme-starter/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/diegoalba/Documents/theta-theme-starter/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/diegoalba/Documents/theta-theme-starter/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/diegoalba/Documents/theta-theme-starter/.claude/agents/gsd-eval-planner.md for instructions.
