...
The keys live in `.claude/settings.json` (project) or `/Users/diegoalba/Documents/theta-theme-starter/.claude/settings.json` (global) — **not** in `.planning/config.json`:
