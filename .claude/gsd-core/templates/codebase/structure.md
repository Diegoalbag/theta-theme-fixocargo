...
- Usage: Reference from command with `@/Users/diegoalba/Documents/theta-theme-starter/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/diegoalba/Documents/theta-theme-starter/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/diegoalba/Documents/theta-theme-starter/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
